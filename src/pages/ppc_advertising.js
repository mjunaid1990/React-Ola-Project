...
import WhyChooseUsPPC from "../partials/why_choose_ppc";
...
function PPCAdvertising() {
    ...
    const fetchFaqsData = () => {
        fetch("https://app.olagee.com/api/faqfront?type=SEM")
            .then(response => {
    ...
    const fetchPlansData = () => {
        fetch("https://app.olagee.com/api/plans?type=SEM")
            .then(response => {
                return response.json()
            })
            .then(data => {
    ...
    const fetchPortfolioData = () => {
        fetch("https://app.olagee.com/api/portfolio?type=SEM")
            .then(response => {
                return response.json()
            })
            .then(data => {
    ...
    const fetchBannerData = () => {
        fetch("https://app.olagee.com/api/banner?type=SEM")
            .then(response => {
                return response.json()
            })
            .then(data => {
