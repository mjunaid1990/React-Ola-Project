...
import WhyChooseUsSeo from "../partials/why_choose_seo";
...
function SearchEnginOptimization() {
    ...
    const fetchFaqsData = () => {
        fetch("https://app.olagee.com/api/faqfront?type=SEO")
            .then(response => {
    ...
    const fetchPlansData = () => {
        fetch("https://app.olagee.com/api/plans?type=SEO")
            .then(response => {
                return response.json()
            })
            .then(data => {
    ...
    const fetchPortfolioData = () => {
        fetch("https://app.olagee.com/api/portfolio?type=SEO")
            .then(response => {
                return response.json()
            })
            .then(data => {
    ...
    const fetchBannerData = () => {
        fetch("https://app.olagee.com/api/banner?type=SEO")
            .then(response => {
                return response.json()
            })
            .then(data => {
...
export default SearchEnginOptimization;